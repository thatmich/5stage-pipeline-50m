...
module thinpad_top (
  ...
  logic wbm0_stb_o;
  logic wbm0_ack_i;
  logic [`ADDR_WIDTH-1:0] wbm0_adr_o;
  logic [`DATA_WIDTH-1:0] wbm0_dat_o;
  logic [`DATA_WIDTH-1:0] wbm0_dat_i;
  ...
  logic wbm1_stb_o;
  logic wbm1_ack_i;
  logic [`ADDR_WIDTH-1:0] wbm1_adr_o;
  logic [`DATA_WIDTH-1:0] wbm1_dat_o;
  logic [`DATA_WIDTH-1:0] wbm1_dat_i;
